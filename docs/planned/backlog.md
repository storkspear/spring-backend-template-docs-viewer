...
6. **새 Item plan 작성 시**: backlog 에서 관련 항목을 plan scope 에 포함 선언. plan 완료 시 해당 backlog 항목 일괄 archive. 규칙 상세: [`conventions/git-workflow.md`](../convention/git-workflow.md).
...
- [`conventions/git-workflow.md`](../convention/git-workflow.md) — backlog 운영 규칙 상세
