...
> 결정 근거: [`../conventions/decisions-infra.md` I-09](../infra/decisions-infra.md#결정-i-09-배포--kamal--docker-bluegreen-mac-mini)
> 전체 구성도: [`../infrastructure.md §4`](../infra/infrastructure.md)
> 평시 운영 / 장애 대응: [`../runbook.md`](../infra/runbook.md)
...
- [`../conventions/decisions-infra.md` I-09](../infra/decisions-infra.md) — Kamal 선택 근거
...
**막혔을 때**: [`../troubleshooting/dogfood-pitfalls.md`](../reference/dogfood-pitfalls.md) (도그푸딩과 같은 함정 적용) / [`../runbook.md`](../infra/runbook.md) (평시 운영 절차)
**왜 이렇게?**: [`../conventions/decisions-infra.md` I-09](../infra/decisions-infra.md) (Kamal 선택) / [`../philosophy.md` 결정 2](./philosophy.md) (template 패턴)
