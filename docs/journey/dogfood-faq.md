...
**현재 안 됨** (2026-04 기준). 이유는 [pitfalls #5 ~ #7](../journey/dogfood-pitfalls.md):
...
2. **모든 키 즉시 폐기 + 재발급** ([key-rotation.md](../infra/key-rotation.md))
...
(만약 새로운 함정 만나면 [pitfalls.md](../journey/dogfood-pitfalls.md) §"새 함정 발견 시" 절차로 추가 PR.)
