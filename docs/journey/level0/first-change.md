...
**왜 `NOT NULL` 안 붙이나?**: 기존 유저 레코드들이 이미 있을 수 있어서. "뒤로 호환" 원칙 ([`../../infra/runbook.md` Expand/Contract 규율](../../infra/runbook.md) 참조). 필수로 만들려면 "2 단계 배포" 를 거쳐야 함.
...
| 테스트 전략 자세히 | [`../../testing/testing-strategy.md`](../../testing/testing-strategy.md) |
| 새 도메인 테이블 추가 | [`../../features/migration.md`](../../features/migration.md) |
