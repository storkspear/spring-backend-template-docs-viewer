...
> **전제**: [`../onboarding.md`](../onboarding.md) 의 환경 셋업 (§1~§3) 완료. `./tools/bootstrap.sh` 또는 `./gradlew bootRun` 직접 실행.
...
| 앱 모듈을 만들어보기 | [`../onboarding.md`](../onboarding.md) §5 `new-app.sh` |
| 뭔가 에러로 막힘 | [`../onboarding.md`](../onboarding.md) §6 "흔한 에러" |
