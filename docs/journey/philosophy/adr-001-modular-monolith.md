> 📚 **Philosophy · 테마 1 — 레포지토리 구조의 기반** (4개 중 1번째)
> [← Philosophy 목차](./README.md) · [→ ADR-002: Use this template](./adr-002-use-this-template.md)
...
- [`factory.bootstrap-module.gradle`](https://github.com/storkspear/spring-backend-template/blob/main/build-logic/src/main/groovy/factory.bootstrap-module.gradle)
...
- [`ArchitectureTest.java`](https://github.com/storkspear/spring-backend-template/blob/main/common/common-testing/src/test/java/com/factory/common/testing/architecture/ArchitectureTest.java)

**Bootstrap 묶음**:
- [`bootstrap/build.gradle`](https://github.com/storkspear/spring-backend-template/blob/main/bootstrap/build.gradle)

---

> 📚 **다음 ADR**: [ADR-002 · Use this template →](./adr-002-use-this-template.md)  
