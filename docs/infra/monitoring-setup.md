...
- [`features/observability.md`](../features/observability.md) — 메트릭/로그 규약
- [`journey/deployment.md`](../journey/deployment.md) — 운영 배포 파이프라인 (Kamal + GHA)
- [`infra/infrastructure.md §4`](./infrastructure.md) — 운영 구성도
- [`infra/decisions-infra.md` I-06](./decisions-infra.md) — 관측성 스택 선택 근거
