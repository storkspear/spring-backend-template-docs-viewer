...
> - 인프라 결정 카드 (Supabase, MinIO, 맥미니, Tunnel, 관측성, Kamal): [`infra/decisions-infra.md`](./decisions-infra.md)
...
**철학 요약** (자세한 근거는 [`philosophy/README.md`](../journey/philosophy/README.md) 의 [ADR-007 (솔로 친화적 운영)](../journey/philosophy/adr-007-solo-friendly-operations.md) / [`decisions-infra.md`](./decisions-infra.md)):
...
- [`infra/decisions-infra.md`](./decisions-infra.md) — 결정 카드 I-01 ~ I-09
- [`../journey/philosophy/README.md`](../journey/philosophy/README.md) — 16 ADR 인덱스 (특히 [ADR-007](../journey/philosophy/adr-007-solo-friendly-operations.md))
