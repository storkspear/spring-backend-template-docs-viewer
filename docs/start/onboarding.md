...
관측성 스택(Loki/Grafana/Prometheus/Alertmanager)은 운영 전용으로 범위가 조정됐습니다. 로컬에서 대시보드/쿼리 동작 확인이 필요하면 Mac mini 운영 환경의 `log.<domain>` 에서 확인하세요. 자세한 기동 방법은 [`monitoring-setup.md`](../production/setup/monitoring-setup.md) (Mac mini 기준) 참조.
...
| 목적 | 문서 |
|---|---|
| 코드 아키텍처 (포트/어댑터, 모듈 의존) | [`./architecture.md`](../structure/architecture.md) |
| 인프라 구성 (DB/스토리지/관측성 전체 상태) | [`../infra/infrastructure.md`](../production/deploy/infrastructure.md) |
| 설계 철학 (16 개 ADR) | [`./philosophy/README.md`](../philosophy/README.md) |
| 문서 작성 규칙 | [`../STYLE_GUIDE.md`](../reference/STYLE_GUIDE.md) |
| 인프라 결정 근거 (Supabase/NAS/맥미니 등) | [`../infra/decisions-infra.md`](../production/deploy/decisions-infra.md) |
| 코딩 규약 (naming, DTO, exception 등) | [`../conventions/`](../conventions/) |
| 테스트 전략 (4층 구조) | [`../testing/testing-strategy.md`](../production/test/testing-strategy.md) |
| 미완료 / 향후 작업 목록 | [`../reference/backlog.md`](../planned/backlog.md) |
| 장애 시나리오 분석 | [`../infra/edge-cases.md`](../reference/edge-cases.md) |
...
[`journey/README.md`](../onboarding/README.md) 의 **2단계 (어떻게 써? 로컬 dev)** 와 **3단계 (클론 후 뭐부터? 첫 앱 모듈 추가)** 입니다.

| 방향 | 문서 | 한 줄 |
|---|---|---|
| ← 이전 | [`./architecture.md`](../structure/architecture.md) | 1단계 — 모듈 구조 한 눈 |
...
**왜 이렇게?**: [`./philosophy/README.md`](../philosophy/README.md) (16 개 ADR · 테마 1~5) / [`../infra/decisions-infra.md`](../production/deploy/decisions-infra.md) (I-01~I-13)
