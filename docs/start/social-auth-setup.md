...
[`journey/README.md`](../onboarding/README.md) 의 **4단계 — 발급은 어디서?** 의 첫 항목 (소셜 로그인) 입니다.
...
**왜 이렇게?**: [ADR-002 (template 패턴)](../philosophy/adr-002-use-this-template.md), [ADR-012 (앱별 독립 유저 모델)](../philosophy/adr-012-per-app-user-model.md) / [`infra/decisions-infra.md`](../production/deploy/decisions-infra.md)
