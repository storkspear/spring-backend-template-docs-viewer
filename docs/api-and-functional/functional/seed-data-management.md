...
이 방식의 장점은 **테스트마다 필요한 최소한의 데이터만** 생성하고, `@Sql(contract-cleanup.sql)` 로 매 테스트 전에 깨끗이 지운다는 점입니다. 상세는 [`testing/contract-testing.md`](../../production/test/contract-testing.md) 를 참조하세요.
...
- [`../testing/contract-testing.md`](../../production/test/contract-testing.md) — 테스트 fixture 전략
- [`../testing/testing-strategy.md`](../../production/test/testing-strategy.md) — 4 층 테스트 구조 (Integration 층에서 seed 사용)
