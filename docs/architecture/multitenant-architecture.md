...
- [`../journey/philosophy/adr-005-db-schema-isolation.md`](../journey/philosophy/adr-005-db-schema-isolation.md) — schema 격리 + 5중 방어선 결정
- [`../journey/philosophy/adr-012-per-app-user-model.md`](../journey/philosophy/adr-012-per-app-user-model.md) — 앱별 독립 유저 모델
- [`./jwt-authentication.md`](./jwt-authentication.md) — `appSlug` 검증 필터
- [`../infra/infrastructure.md`](../infra/infrastructure.md) — 실제 schema 배치 (Supabase)
