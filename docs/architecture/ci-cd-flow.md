...
[`../README.md`](../README.md) 의 **5단계 (테스트)** 또는 **7단계 (운영 배포)** 의 흐름이 궁금할 때 펼치는 다이어그램 reference 입니다.

| 방향 | 문서 | 한 줄 |
|---|---|---|
| ← 본문 1 | [`../guides/dogfood-setup.md`](../guides/dogfood-setup.md) | 4~6단계, 도그푸딩 (template 자체 검증) |
| ← 본문 2 | [`../guides/deployment.md`](../guides/deployment.md) | 7단계, 파생 레포 첫 운영 배포 |

**막혔을 때**: [`../troubleshooting/dogfood-pitfalls.md`](../troubleshooting/dogfood-pitfalls.md) (11회 함정 모음)
**왜 이렇게?**: [`../conventions/decisions-infra.md` I-09 ~ I-14](../conventions/decisions-infra.md) (CI/CD 결정 카드)
