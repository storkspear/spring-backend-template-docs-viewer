...
**Breaking change 가 있는 템플릿 버전** 의 이행 가이드 작성 규칙 + Deprecation 흐름과의 관계 + 파생 레포 업그레이드 사용법.
...
- [`api-contract/versioning.md`](../api-contract/versioning.md) — semver 규약 · Deprecation 프로세스
- [`journey/cross-repo-cherry-pick.md`](../journey/cross-repo-cherry-pick.md) — 파생 레포 동기화
- `CHANGELOG.md` — 버전별 전체 변경 이력 (레포 루트)
