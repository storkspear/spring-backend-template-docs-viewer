...
> 결정 근거: [`../conventions/decisions-infra.md` I-10, I-14](../conventions/decisions-infra.md)
...
**새 발급**:
- [`../guides/dogfood-setup.md §3.1`](../guides/dogfood-setup.md) 의 절차 따름
...
**새 발급**:
- [`../guides/dogfood-setup.md §3.2`](../guides/dogfood-setup.md) 의 절차 따름
...
- [`../guides/dogfood-setup.md`](../guides/dogfood-setup.md) — 외부 리소스 발급 절차
- [`../conventions/decisions-infra.md` I-10, I-14](../conventions/decisions-infra.md) — PAT / Tailscale OAuth 결정 근거
- [`../troubleshooting/dogfood-pitfalls.md`](../troubleshooting/dogfood-pitfalls.md) — 키 관련 함정
