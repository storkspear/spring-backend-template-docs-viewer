...
> 결정 근거: [`../conventions/decisions-infra.md` I-09](../conventions/decisions-infra.md#결정-i-09-배포--kamal--docker-bluegreen-mac-mini)
> 전체 구성도: [`../infrastructure.md §4`](../infrastructure.md)
...
- [`../conventions/decisions-infra.md` I-09](../conventions/decisions-infra.md) — Kamal 선택 근거
- [`../runbook.md`](../runbook.md) — 평시 배포 / 롤백 / 장애 대응
- [`monitoring-setup.md`](./monitoring-setup.md) — Grafana / Prometheus / Alertmanager 운영
- [`onboarding.md`](./onboarding.md) — 새 개발자 첫 실행 (로컬 dev)
- [`storage-setup.md`](./storage-setup.md) — MinIO 로컬/NAS

---

## 📖 책 목차 — Journey 7단계

[`../README.md`](../README.md) 의 **7단계 — 이제 use this template** 입니다. 파생 레포 첫 운영 배포.
...
**막혔을 때**: [`../troubleshooting/dogfood-pitfalls.md`](../troubleshooting/dogfood-pitfalls.md) (도그푸딩과 같은 함정 적용) / [`../runbook.md`](../runbook.md) (평시 운영 절차)
**왜 이렇게?**: [`../conventions/decisions-infra.md` I-09](../conventions/decisions-infra.md) (Kamal 선택) / [`../philosophy.md` 결정 2](../philosophy.md) (template 패턴)
