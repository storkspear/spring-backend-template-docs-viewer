...
> 정상 흐름: [`../guides/dogfood-setup.md`](../guides/dogfood-setup.md)
...
5. ADR 변경이 필요한 결정이면 [`../conventions/decisions-infra.md`](../conventions/decisions-infra.md) 에 새 카드 추가

## 관련 문서

- [`../guides/dogfood-setup.md`](../guides/dogfood-setup.md) — 정상 흐름 (이 함정들 없이 가는 길)
- [`../architecture/ci-cd-flow.md`](../architecture/ci-cd-flow.md) — 다이어그램 + phase 별 안전망
- [`../conventions/decisions-infra.md` I-09 ~ I-14](../conventions/decisions-infra.md) — ADR (왜 이 결정을)
- [`../security/key-rotation.md`](../security/key-rotation.md) — 키 노출 시 절차

---

## 📖 책 목차 — Journey 5단계 보조

[`../README.md`](../README.md) 의 **5단계 (테스트)** 의 막혔을 때 검색 reference 입니다. 정상 흐름이 아닌 **사고 실록** 톤으로 작성되어 있습니다.

| 방향 | 문서 | 한 줄 |
|---|---|---|
| ← 본문 | [`../guides/dogfood-setup.md`](../guides/dogfood-setup.md) | 4~6단계, 도그푸딩 정상 흐름 |
| → 본문 (이어서) | 위 dogfood-setup.md 의 다음 step | 함정 해결 후 본문으로 복귀 |

**다이어그램**: [`../architecture/ci-cd-flow.md`](../architecture/ci-cd-flow.md) (commit→배포 phase 별 안전망)
**왜 이렇게?**: [`../conventions/decisions-infra.md` I-09 ~ I-14](../conventions/decisions-infra.md) (각 함정의 결정 근거)
