...
>
> 관련 문서:
> - 운영 배포 절차: [`deployment.md`](../deploy/deployment.md)
> - 평시 운영 / 장애 대응: [`infra/runbook.md`](../deploy/runbook.md)
> - 인프라 결정 카드 (Supabase, MinIO, 맥미니, Tunnel, 관측성, Kamal): [`infra/decisions-infra.md`](../deploy/decisions-infra.md)
> - 전체 인프라 개요: [`infra/infrastructure.md`](../deploy/infrastructure.md)
...
**철학 요약** (자세한 근거는 [`philosophy/README.md`](../../philosophy/README.md) 의 [ADR-007 (솔로 친화적 운영)](../../philosophy/adr-007-solo-friendly-operations.md) / [`decisions-infra.md`](../deploy/decisions-infra.md)):
...
자세한 동작은 [`deployment.md`](../deploy/deployment.md) + [`runbook.md`](../deploy/runbook.md) 참조.
...
자세한 2-tier bucket 규약: [`features/storage.md`](../../api-and-functional/functional/storage.md).
...
- [`deployment.md`](../deploy/deployment.md) — 파생레포 onboarding (최초 1회)
- [`infra/runbook.md`](../deploy/runbook.md) — 평시 운영 / 롤백 / 장애 대응
- [`monitoring-setup.md`](./monitoring-setup.md) — 관측성 스택 상세
- [`infra/infrastructure.md`](../deploy/infrastructure.md) — 전체 인프라 개요
- [`infra/decisions-infra.md`](../deploy/decisions-infra.md) — 결정 카드 I-01 ~ I-09
- [`../journey/philosophy/README.md`](../../philosophy/README.md) — 16 ADR 인덱스 (특히 [ADR-007](../../philosophy/adr-007-solo-friendly-operations.md))
- [`infra/edge-cases.md`](../../reference/edge-cases.md) — 리스크 시나리오
