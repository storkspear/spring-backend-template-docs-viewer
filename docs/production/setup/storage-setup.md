...
> **파생 레포 개발자** 는 [`onboarding.md`](../../start/onboarding.md) §3.3 를 참조하세요 (`dev-shared` 또는 본인 환경 이름).
>
> 인프라 전체 구성 / 책임 분담: [`infra/infrastructure.md`](../deploy/infrastructure.md)
> bucket 네이밍 / key 패턴 규약: [`features/storage.md`](../../api-and-functional/functional/storage.md)
> 선택 근거 (왜 NAS MinIO?): [`infra/decisions-infra.md`](../deploy/decisions-infra.md) I-03
...
- 스토리지 사용 규약: [`../features/storage.md`](../../api-and-functional/functional/storage.md)
...
- [`features/storage.md`](../../api-and-functional/functional/storage.md) — StoragePort 사용 패턴
- [`infra/monitoring-setup.md`](./monitoring-setup.md) — Grafana/Prometheus 연동
