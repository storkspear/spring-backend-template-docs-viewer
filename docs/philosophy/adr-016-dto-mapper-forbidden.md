...
**관련 문서**:
- [`conventions/dto-factory.md`](https://github.com/storkspear/template-spring/blob/main/docs/conventions/dto-factory.md) — 정적 팩토리 허용 규칙 상세
- [`architecture/module-dependencies.md`](https://github.com/storkspear/template-spring/blob/main/docs/architecture/module-dependencies.md) — `NO_MAPPER_CLASSES` ArchUnit 규칙
