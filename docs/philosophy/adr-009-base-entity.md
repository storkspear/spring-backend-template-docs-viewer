...
**BaseEntity 구현**:
- [`BaseEntity.java`](https://github.com/storkspear/template-spring/blob/main/common/common-persistence/src/main/java/com/factory/common/persistence/entity/BaseEntity.java) — 55줄 전체
