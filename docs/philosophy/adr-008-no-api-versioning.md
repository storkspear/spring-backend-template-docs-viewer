...
**미래 도입 관련 문서**:
- [`docs/api-contract/versioning.md`](../api-and-functional/api/versioning.md) — 템플릿 단위 SemVer + API URL 버전 관리 **미도입** 근거
- [`docs/api-contract/flutter-backend-integration.md`](../api-and-functional/api/flutter-backend-integration.md) — 클라이언트 통합 (버전 언급 없음)
